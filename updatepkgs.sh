...
rsync --rsh='ssh -p 18822' -ia aur@aur.vond.net:/opt/web-stack/aur/x86_64/vond* /tmp/local-repo/
...
rsync --rsh='ssh -p 18822' -ai /tmp/local-repo/ aur@aur.vond.net:/opt/web-stack/aur/x86_64/
